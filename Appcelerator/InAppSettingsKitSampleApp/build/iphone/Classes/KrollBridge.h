...
@interface TiIASKSampleObject : KrollCoverageObject {
#else
@interface TiIASKSampleObject : KrollObject {
#endif
@private
...
extern NSString * TiIASKSample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TiIASKSampleObject *_tiiasksample;
    KrollObject* console;
	BOOL shutdown;
