...
// in simulator we redefine to format for TiIASKSample Developer console
...
{\
	NSString * exceptionName = [@"org.tiiasksample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiiasksample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITiIASKSampleNativeItemNone = -1, 
	UITiIASKSampleNativeItemSpinner = -2,
	UITiIASKSampleNativeItemProgressBar = -3,
	
	UITiIASKSampleNativeItemSlider = -4,
	UITiIASKSampleNativeItemSwitch = -5,
	UITiIASKSampleNativeItemMultiButton = -6,
	UITiIASKSampleNativeItemSegmented = -7,
	
	UITiIASKSampleNativeItemTextView = -8,
	UITiIASKSampleNativeItemTextField = -9,
	UITiIASKSampleNativeItemSearchBar = -10,
	
	UITiIASKSampleNativeItemPicker = -11,
	UITiIASKSampleNativeItemDatePicker = -12,
	
	UITiIASKSampleNativeItemInfoLight = -13,
	UITiIASKSampleNativeItemInfoDark = -14,
	
	UITiIASKSampleNativeItemDisclosure = -15,
	
	UITiIASKSampleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TiIASKSample instances of
