...
/**
 Base class for all TiIASKSample views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TiIASKSample view hierarchy (such as wrapped iOS UIViews) was touched.
