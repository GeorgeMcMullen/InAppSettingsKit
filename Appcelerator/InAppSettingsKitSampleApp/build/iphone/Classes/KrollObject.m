 ...
 * Copyright (c) 2009-2011 by TiIASKSample, Inc. All Rights Reserved.
...
//@interface TiIASKSampleObject : NSObject
//@end

@interface TiIASKSampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiIASKSampleObject class]])
		{
			for (NSString *key in [[(TiIASKSampleObject*)o modules] allKeys])
			{
