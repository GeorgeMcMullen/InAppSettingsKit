...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.inappsettingskit.inappsettingskit.js')
	...
	f = os.path.join(cwd,'Classes','ComInappsettingskitInappsettingskitModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.inappsettingskit.inappsettingskit.js']
